...
export default function About(){
  ...
  const glows=[
    ...
    "bottom-0 right-10 w-[420px] h-[420px] opacity-15 blur-[140px] dealy-300",
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            ">
              I build scalable, modern application with a strong focus on clean architecture, delightful UX, and performance. My toolkit spans Java, React, Next.js, TypeScript, Tailwind CSS, and RestfulAPI-bringing ideas to life from concept to production with robust APIs and smooth interfaces.
            </p>
        ...
        >
          ...
          <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
            I'am a software Developer, Content Creater, and Web Developer - possionate about building fast,resilient applications and sharing coding insights on Instagram and YouTube.
          </p>
          <p className="mt-4 text-gray-400 text-base sm:text-lg">
            I love turning ideas into scalable, user-friendly products that make on impact.
          </p>
        </motion.div>
      </div>
    </section>
