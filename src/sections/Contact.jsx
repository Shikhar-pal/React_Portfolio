        ...
        >
          ...
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            <div className="flex flex-col">
              ...
              className={`p-3 rounded-md bg-white/10 ${errors.name ? "border-red-500" : "border-gray-500"} text-white focus:outline-none focus:border-blue-500`}
            ...
            <div className="flex flex-col">
              ...
              onChange={handleChange}
              className={`p-3 rounded-md bg-white/10 ${errors.email ? "border-red-500" : "border-gray-500"} text-white focus:outline-none focus:border-blue-500`}
            ...
            <div className="flex flex-col">
              ...
              onChange={handleChange}
              className={`p-3 rounded-md bg-white/10 ${errors.service ? "border-red-500" : "border-gray-500"} text-white focus:outline-none focus:border-blue-500`}
              >
            ...
            {formData.service && formData.service !== "other" && (
              <div className="flex flex-col">
                ...
                className={`p-3 rounded-md bg-white/10 ${errors.budget ? "border-red-500" : "border-gray-500"} text-white focus:outline-none focus:border-blue-500`}
                />
            ...
            <div className="flex flex-col">
              <label className="mb-1">
                ...
                value={formData.idea}
                onChange={handleChange}
                className={`p-3 rounded-md bg-white/10 ${errors.idea ? "border-red-500" : "border-gray-500"} text-white focus:outline-none focus:border-blue-500`}
                ></textarea>
