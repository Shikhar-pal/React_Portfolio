import {motion , delay, useTransform, useScroll } from "framer-motion";
...
const experiences = [
  {
    ...
    description:
      "Pursuing B.Tech in Computer Science and Engineering with Artificial Intelligence, building strong foundations in DSA, OOPs, DBMS, OS, and modern web development.",
  },
  {
    role: "Frontend Web Development Learner",
    company: "Self Projects",
    duration: "2024 - Present",
    description:
      "Built responsive web projects including a Portfolio Website, Razorpay Clone UI, and an Image Gallery Web Application using HTML, CSS, JavaScript, and Tailwind CSS.",
  },
  {
    ...
    duration: "2024 - Present",
    description:
      "Developed a Heart Disease Prediction System using Python, NumPy, Pandas, and Scikit-learn, focusing on data preprocessing, analysis, and ML model evaluation.",
  },
];
...
function ExperienceItem({exp , idx ,start , end , scrollYProgress , layout}){
  ...
  return(
    <div className="relative flex items-start">
      ...
      <motion.div className="absolute -left-[14px] top-3 z-110 w-7 h-7 rounded-full bg-white shadow-[0_0_0_8px_rgba(255,255,255,0.1)]"
      style={{scale , opacity}}
      >

      </motion.div>

      <motion.article className="bg-gray-900/80 backdrop-blur border border-gray-700/70 rounded-xl
